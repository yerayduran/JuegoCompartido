...
public class Juego{
    private static String[] habitacionesTotales = new String[]{habitaciones[habitacionActual], habitaciones[habitacionActual + 1], habitaciones[habitacionActual + 2], habitaciones[habitacionActual + 3], habitaciones[habitacionActual + 4], habitaciones[habitacionActual + 5]};
